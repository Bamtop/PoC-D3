...
onMounted(() => {
  ...
  svg
    ...
    .attr("height", 800)
    .html(
      `<div class=test style="display:flex;flex-direction:column; align-items:center;width: 100%; height: 100%;border-radius:25%;padding-top:25px;color:#69696980">
